...
import com.linecorp.armeria.server.grpc.kotlin.CoroutineServerInterceptor
import io.grpc.*
import kotlinx.coroutines.delay
import org.slf4j.LoggerFactory

class AuthCoroutineServerInterceptor : CoroutineServerInterceptor {
    ...
    companion object {
        private val log = LoggerFactory.getLogger(AuthCoroutineServerInterceptor::class.java)
    }
}
